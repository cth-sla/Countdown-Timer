...
import { Volume2, Bell, AlertTriangle, Settings2, Sparkles, HelpCircle } from 'lucide-react';
          ...
          {config.warningEnabled ? (
            <div className="flex flex-col gap-4 mt-2">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <SoundSelector
                  selectedId={config.warningSound}
                  onSelect={(id) => updateField('warningSound', id)}
                  volume={config.warningVolume}
                  type="warning"
        ...
        <div className="bg-slate-50/50 dark:bg-slate-950/30 rounded-2xl p-5 border border-slate-100 dark:border-slate-900/40 flex flex-col gap-4 relative overflow-hidden">
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <SoundSelector
                selectedId={config.endSound}
                onSelect={(id) => updateField('endSound', id)}
                volume={config.endVolume}
                type="end"
                customSounds={customSounds}
                onAddCustomSound={onAddCustomSound}
                onDeleteCustomSound={onDeleteCustomSound}
